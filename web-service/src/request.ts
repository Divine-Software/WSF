...
export class WebRequest implements AuthSchemeRequest {
    ...
    /** The request ID. It's either generated or extracted from the incoming message, if [[WebServiceConfig.trustRequestID]] is configured. */
     ...
     * @throws             [[WebError]]([[WebStatus.BAD_REQUEST]]) if the requested header is missing and no default was
     *                     provided.
     ...
     * @throws                 [[WebError]]([[WebStatus.PAYLOAD_TOO_LARGE]]) if the request body was larger than
     *                         allowed.
