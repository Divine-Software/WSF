...
export class WebRequest implements AuthSchemeRequest {
     ...
     * @param  def         The default value to return, in case the parameter was not found. If not specified, an
     *                     exception will be thrown instead.
     * @throws {WebError}  {@link WebStatus.INTERNAL_SERVER_ERROR} if the requested header is missing and no default was
     *                     provided.
     ...
     * @param   def          The default value to return, in case the header was not found. If not specified, an
     *                       exception will be thrown instead.
     ...
     * @throws {WebError}    {@link WebStatus.BAD_REQUEST} if the requested header is missing and no default was
     *                       provided.
